	...
	<tbody>
		<tr valign="top">
			...
			<td class="forminp forminp-text">
				<input type="text" class="wdm_wpi_input wdm_wpi_text" name="wdm_form_data[user_email]" id="wdm_user_email" value="<?php echo esc_attr( empty( $form_data['user_email'] ) ? get_option( 'admin_email' ) : $form_data['user_email'] ); ?>" />
		...
		<tr valign="top">
			...
			<td class="forminp forminp-text">
				<input type="text" class="wdm_wpi_input wdm_wpi_text" name="wdm_form_data[default_sub]" id="wdm_default_sub" value="<?php echo esc_attr( empty( $form_data['default_sub'] ) ? __( 'Enquiry for a product from ', 'product-enquiry-for-woocommerce' ) . get_bloginfo( 'name' ) : $form_data['default_sub'] ); ?>"  />

	...
	<tbody>
		<tr valign="top">
			...
			<td class="forminp forminp-text">
				...
				?>
				<textarea class="input-without-tip" id="user_custom_css" name="wdm_form_data[user_custom_css]" rows="10" cols="80"><?php echo esc_attr( $user_custom_css ); ?></textarea>
			</td>
		</tr>
		<tr valign="top">
			<th scope="row" class="titledesc">
						...
						<div class="layer_parent">
							<div class="pew_upgrade_layer">
								<div class="pew_uptp_cont">
									...
									<a class="wdm_view_det_link" href="https://goo.gl/gBtwX4" target="_blank"><?php esc_attr_e( 'View Details ', 'product-enquiry-for-woocommerce' ); ?> </a>
								</div>
							</div>

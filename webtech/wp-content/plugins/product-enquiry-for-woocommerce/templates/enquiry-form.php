	...
	" style="display:none;">
		<form id="enquiry-form" action="#" method="POST">
			...
			<div class="wdm-terms-cond-cb">
				<input type='checkbox' id='terms-cond-cb' name='enable_terms_conditions' value='1' required data-msg-required='<?php esc_attr_e( 'Please select terms and conditions', 'product-enquiry-for-woocommerce' ); ?>' checked/> <span class='terms-cond-text'>
					<?php
					// @codingStandardsIgnoreLine 
					echo get_terms_conditions_text();
					?>
					</span>
			</div>
			<?php } ?>
			<div class="wdm-enquiry-action-btns">
				<button id="send-btn" type='submit' class='contact-send contact-button alt' ><?php esc_attr_e( 'Send', 'product-enquiry-for-woocommerce' ); ?></button>
